//
//  ListPrimitivesWithDefaults.swift
//  EditDialogs
//
...
struct ListPrimitivesWithDefaults: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(String("Primitives defaults"))
...
fileprivate final class Model: ObservableObject {
    ...
    typealias PresentableKey = PrimitivePresentableKey<KeyID, PrimitiveWithDefault>
    ...
    func load() async {
        ...
        keys = [
            PresentableKey(
                ...
                value: PrimitiveWithDefault.bool(value: true, default: true)
            ),
            PresentableKey(
                id: "string",
                title: "String with default",
                description: "String description",
                value: PrimitiveWithDefault.string(value: "string-value", default: "string-value")
            ),
            PresentableKey(
                id: "int",
                title: "Int with default",
                description: "Int description",
                value: PrimitiveWithDefault.int(value: 77, default: 77)
            ),
            PresentableKey(
                id: "double",
                title: "Double with default",
                value: PrimitiveWithDefault.double(value: 3.146, default: 3.146)
            )
        ]
